...
namespace Kaazing.K3po.NUnit
{
    ...
    public class K3poRule
    {
        ...
        public void Prepare(string[] scripts)
        {
            ...
            latch.AwaitPrepared();
            Logger.LogMessage("K3po script Prepared");
        }
        ...
        public void Start()
        {
            ...
            Logger.LogMessage("K3po script Started");
        }
        ...
        public void Finish()
        {
            ...
            {
                latch.AwaitFinished();
                Logger.LogMessage("K3po scirpt finished");
            }
        }
        ...
        public void Finish(int timeout)
        {
            ...
            {
                Logger.LogMessage("K3po scirpt timeout, abort now");
                Abort();
            }
        }
        ...
        public void Abort()
        {
            ...
            _scriptRunner.Abort();
            latch.AwaitFinished();
            Logger.LogMessage("K3po scirpt aborted");
        }
